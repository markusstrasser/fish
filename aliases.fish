...
#alias fhis='function f; eval (history | fzf); end; f'  #Fuzzy search for a command in the history and execute it:
...
#? This is great. Modified it to not ask for temp files (aka when using fifc fzf search)
# alias rm 'command grm --interactive --verbose' # exclude tempfiles
